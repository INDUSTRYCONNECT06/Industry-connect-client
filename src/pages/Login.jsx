...
const Popup = ({Close}) => {
  ...
  return (
    <div className="bg-[#65646490] w-full h-full z-10 fixed top-0 left-0 flex items-center justify-center">
      <div className="flex flex-col gap-10 items-center justify-center border border-[#E6E6E6] px-[52px] py-[107px] shadow-black rounded-md bg-white">
        <h1 className="text-xl font-semibold">You Want To </h1>
        <button className="w-96 px-20 py-4 border border-[rgba(117, 117, 117, 0.11)] rounded-lg  text-md font-normal text-[#0000008A] transition-transform hover:scale-105 hover:bg-main-blue-01 hover:text-white flex items-center gap-4 justify-center"
...
const Login = () => {
  ...
  const handleGoogleLogin = async () =>{
    window.open(`${import.meta.env.VITE_HOST}/google/auth`, "_self");
  }
  ...
  return (
    <>
      ...
      <div className="flex items-center justify-center w-full my-16">
        <div className="flex flex-col gap-10 items-center justify-center border border-[#E6E6E6] px-[52px] py-[107px] shadow-black rounded-md">
